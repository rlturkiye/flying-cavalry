...
class DepthPlanner(Camera):
    """
    You get depth in camera plan, i.e., all points that are in plan parallel to camera have same depth.
    """
    ...
    def fetch_single_img(self):
        ...
        response = self.client.simGetImages([airsim.ImageRequest(self.camera_name, airsim.ImageType.DepthPlanner, pixels_as_float=True, compress=False)])[0]
    ...
    def save_single_img(self, file_name= "DepthPlanner "+str(datetime.datetime.now()), path="./", format=".png"):
        """
