...
def registerEnv(num_actions, use_depth, step_length, image_width, image_height, sim_speed):
    env_config = {
        "observation_space": spaces.Dict({
            ...
            "linear_vel": spaces.Box(low=-64, high=64, shape=(3,), dtype=np.float64),
            "linear_acc": spaces.Box(low=-64, high=64, shape=(3,), dtype=np.float64),
            "angular_vel": spaces.Box(low=-64, high=64, shape=(3,), dtype=np.float64),
            "angular_acc": spaces.Box(low=-64, high=64, shape=(3,), dtype=np.float64),
